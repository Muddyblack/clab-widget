...
Your [b]containerlab[/b] and [b]netlab[/b] labs at a glance, on the desktop, in a panel or in the system tray. See what's running, what broke, and jump back into the right tool. A companion to containerlab-app and netlab-ui, not a replacement.

[i]Community project, not affiliated with srl-labs/Nokia (containerlab) or ipSpace (netlab).[/i]

---

[b]Features[/b]
[list]
[*] [b]Every lab:[/b] containerlab and netlab side by side; a netlab lab running on containerlab shows up once.
[*] [b]Node health:[/b] running / partial / stopped, memory per lab and node, clab-ui role icons.
[*] [b]Topology map:[/b] links and roles, saved clab-ui positions, pan and zoom; smooth up to 700+ nodes.
